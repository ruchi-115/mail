...
// to make a POST request to /emails, passing in values for recipients, subject, and body.
...
//view particular mail on click from mailbox
function load_email(id, mailbox) {
  ...
  fetch(`/emails/${id}`)
    ...
    .then(email => {
      ...
      //on click of reply button get redirected to compose mail page with sender mail already filled
